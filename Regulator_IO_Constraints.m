function u0 = Regulator_IO_Constraints(A, B, Bv, C, D, N, xinit, uprev, zref, dist, Qz, Hs, u_min, u_max,delta_u_min,delta_u_max,zmin,zmax)
    ...
    Zmin = repmat(zmin, N, 1); % Lower bounds on outputs
    Zmax = repmat(zmax, N, 1); % Upper bounds on outputs
